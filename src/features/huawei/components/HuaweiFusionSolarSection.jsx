...
export default function HuaweiFusionSolarSection() {
  return (
    <section className="w-full flex flex-col items-center gap-[24px] md:gap-[32px] font-sf">
      <div className="w-full max-w-[1300px] mx-auto">
        <div className="md:hidden w-full bg-[#1D1D1F] rounded-[12px] px-[16px] py-[16px]">
          <div className="max-w-[312px] flex flex-col gap-[8px]">
            <p className="text-white text-[18px] font-normal leading-[26px]">
              Giải pháp điện mặt trời FushionSolar
            </p>
            <p className="text-white text-[20px] font-semibold leading-[1]">
              Cải tiến vượt trội
            </p>
          </div>
        </div>
        <div className="relative w-full h-[262px] md:h-[640px] rounded-[12px] overflow-hidden">
          ...
          <div className="hidden md:flex relative z-10 h-full w-full flex-col justify-center gap-[8px] px-[109px] py-[254px]">
            <div className="max-w-[312px] flex flex-col gap-[8px]">
              <p className="text-white text-[32px] font-normal leading-[43px]">
                Giải pháp điện mặt trời FushionSolar
              </p>
              <p className="text-white text-[32px] font-semibold leading-[1]">
                Cải tiến vượt trội
              </p>
            </div>
          </div>
      ...
      <h2 className="text-white text-center text-[20px] md:text-[32px] font-semibold leading-[1] max-w-[520px] md:max-w-none">
        ...
        <div className="flex flex-col items-center md:items-stretch md:flex-row gap-[16px]">
          {safetyItems.map((item) => (
            ...
            >
              ...
              <p className="text-white text-center text-[16px] md:text-[16px] font-semibold leading-[1]">
                {item}
              </p>
            </div>
          ))}
